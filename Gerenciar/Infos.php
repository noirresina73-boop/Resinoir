      ...
      <div class="formulario">
        <form id="formAnum" data-bs-theme="dark" method="post" action="./Controllers/infosController.php">
          ...
          <div class="form-floating mb-3">
            <input name="id" type="number" class="form-control no-decor" id="floatingInput" value="1" readonly="true">
          ...
          <div class="input-group mb-3">
            ...
            <input name="idPDR" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
          ...
          <div class="input-group mb-3">
            ...
            <input name="modelo" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Tamanho</span>
            <input name="tamanho" type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Cor</span>
            <input name="cor" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Capa</span>
            <input name="capa" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text">R$</span>
            <span class="input-group-text">0.00</span>
            <input name="valor" step="0.01" type="number" class="form-control" aria-label="Dollar amount (with dot and two decimal places)">
          </div>
          <div class="input-group mb-3">
            <span class="input-group-text" id="inputGroup-sizing-default">Estoque</span>
            <input name="estoque" type="number" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
          </div>
          <div class="mb-3">
    ...
    "url": ""
      ...
      <div class="post">
        <div class="card" style="width: 18rem;" data-bs-theme="dark">
          <img src="https://raw.githubusercontent.com/noirresina73-boop/fts/refs/heads/main/FT_broche_craneo%20(1).jpeg" class="card-img-top" alt="...">
          <div class="card-body">
